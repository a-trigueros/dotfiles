...
function Setup-SSHServices
{
  <#
    .SYNOPSIS
        Setup SSH daemon and agent services and sets them to automatic startup
    #>
  Write-Host "Configuring SSH services..." -ForegroundColor Cyan
    
  # Configure SSH daemon
  Set-Service -Name sshd -StartupType 'Automatic'
  Write-Host "SSH daemon set to automatic" -ForegroundColor Green
    
  # Configure SSH agent
  Set-Service -Name 'ssh-agent' -StartupType 'Automatic'
  Write-Host "SSH agent set to automatic" -ForegroundColor Green
}
